...
WW_EXPORT void         loggertunnelTunnelDestroy(tunnel_t *t, const ww_lifecycle_context_t *context);
...
void                   loggertunnelTunnelOnStop(tunnel_t *t, const ww_lifecycle_context_t *context);
