...
void testChaCha20Poly1305()
{
    ...
    const uint8_t nonce[12]                          = {0x01}; // Example nonce
    uint8_t       ciphertext[sizeof(plaintext) + 16] = {0};
    uint8_t       decrypted[sizeof(plaintext)]       = {0};
    uint8_t       expected[sizeof(plaintext) + 16]   = {

        0x12, 0x98, 0x9f, 0x9c, 0xce, 0x7c, 0xbb, 0xd1, 0xd0, 0xb8, 0xb8, 0x2c, 0xba, 0x59,
        0xfc, 0x7c, 0x47, 0xfd, 0x34, 0x2a, 0x37, 0x6d, 0xa0, 0x46, 0xb0, 0xde, 0xfa, 0x9c,
        0xa6, 0xf3, 0xad, 0x66, 0x31, 0x2a, 0x7a, 0x7c, 0x27, 0xf5, 0x2a, 0xc1, 0xee, 0x00};
