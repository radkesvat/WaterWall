...
Sync note: Any change to this file must also be applied to WaterWall/WaterWall-Docs/docs/02-noderefs/data-as-packet.mdx, and both files must keep the same documentation version.
-->
