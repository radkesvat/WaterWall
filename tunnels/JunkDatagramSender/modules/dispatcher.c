...
const junkdatagramsender_module_descriptor_t *junkdatagramsenderGetModuleDescriptors(size_t *count)
{
    static const junkdatagramsender_module_descriptor_t descriptors[] = {
        {.protocol = kJunkDatagramSenderProtocolDns, .canonical_name = "dns", .generate = junkdatagramsenderDnsGenerate},
        {.protocol = kJunkDatagramSenderProtocolDhcp, .canonical_name = "dhcp", .generate = junkdatagramsenderDhcpGenerate},
        {.protocol = kJunkDatagramSenderProtocolNtp, .canonical_name = "ntp", .generate = junkdatagramsenderNtpGenerate},
        ...
        {.protocol = kJunkDatagramSenderProtocolMdns, .canonical_name = "mdns", .generate = junkdatagramsenderMdnsGenerate},
        {.protocol = kJunkDatagramSenderProtocolSnmp, .canonical_name = "snmp", .generate = junkdatagramsenderSnmpGenerate},
