...
static inline void tcpconnectorApplyReadPreference(const tcpconnector_lstate_t *ls)
{
    if (UNLIKELY(wioIsSpliceEnabled(ls->io) && linePrefersOrdinaryReadDownstream(ls->line)))
