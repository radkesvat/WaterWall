...
#define GRPC_MESSAGE_HDLEN 5
    ...
    static inline void grpc_message_hd_pack(const grpc_message_hd *restrict hd, unsigned char *restrict buf)
    {
        unsigned char *p = buf;
        // flags
        *p++ = hd->flags;
    ...
    static inline void grpc_message_hd_unpack(grpc_message_hd *restrict hd, const unsigned char *restrict buf)
    {
