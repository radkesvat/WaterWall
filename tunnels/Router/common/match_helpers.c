                         ...
                         const char *json_path)
{
    ...
    *out_count  = 0;
    ...
    // geoip entries are skipped, so at most patterns->count numeric ranges exist.
    ...
    for (uint32_t i = 0; i < patterns->count; ++i)
    {
        ...
        // geoip is accepted but intentionally not implemented yet: it never
        // contributes a numeric range and therefore never matches.
