...
WW_EXPORT void         realityserverTunnelDestroy(tunnel_t *t, const ww_lifecycle_context_t *context);
...
void realityserverTunnelOnStop(tunnel_t *t, const ww_lifecycle_context_t *context);
...
bool realityserverTls12RecordTrackerFeed(realityserver_tls12_record_tracker_t *tracker, const uint8_t *data,
                                         size_t len);
...
bool realityserverTlsRecordBoundaryTrackerFeed(realityserver_tls_record_boundary_tracker_t *tracker,
                                               const uint8_t *data, size_t len, bool stop_at_boundary,
                                               size_t *consumed);
...
WCRYPTO_MUST_USE wcrypto_status_t realityserverEncryptAead(uint32_t algorithm, unsigned char *dst, size_t dst_capacity,
                                                           const unsigned char *src, size_t src_len,
                                                           const unsigned char *ad, size_t ad_len,
                                                           const unsigned char *nonce, const unsigned char *key);
WCRYPTO_MUST_USE wcrypto_status_t realityserverDecryptAead(uint32_t algorithm, unsigned char *dst, size_t dst_capacity,
                                                           const unsigned char *src, size_t src_len,
                                                           const unsigned char *ad, size_t ad_len,
                                                           const unsigned char *nonce, const unsigned char *key);
