...
WW_EXPORT void         halfduplexclientTunnelDestroy(tunnel_t *t, const ww_lifecycle_context_t *context);
...
void halfduplexclientTunnelOnStop(tunnel_t *t, const ww_lifecycle_context_t *context);
