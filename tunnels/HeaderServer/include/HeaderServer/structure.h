...
WW_EXPORT void         headerserverTunnelDestroy(tunnel_t *t, const ww_lifecycle_context_t *context);
...
void headerserverTunnelOnStop(tunnel_t *t, const ww_lifecycle_context_t *context);
