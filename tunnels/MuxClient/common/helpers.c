                                ...
                                muxclient_lstate_t *child_ls, sbuf_t *buf)
{
    ...
    lineRef(parent_l);
    discard muxclientMaybeSendChildFlowPause(t, parent_l, ts, parent_ls, child_ls->l, child_ls);
    ...
    if (keep_parsing)
    {
        keep_parsing = muxclientShedForParentBufferLimit(t, parent_l, ts, parent_ls);
    }
    lineUnref(parent_l);
    return keep_parsing;
}
