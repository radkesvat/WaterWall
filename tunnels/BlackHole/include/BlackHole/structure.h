...
WW_EXPORT void         blackholeTunnelDestroy(tunnel_t *t, const ww_lifecycle_context_t *context);
...
void                   blackholeTunnelOnStop(tunnel_t *t, const ww_lifecycle_context_t *context);
