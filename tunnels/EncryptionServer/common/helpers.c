...
wcrypto_status_t encryptionserverEncryptAead(uint32_t algorithm, unsigned char *dst, size_t dst_capacity,
...
wcrypto_status_t encryptionserverDecryptAead(uint32_t algorithm, unsigned char *dst, size_t dst_capacity,
                                             const unsigned char *src, size_t src_len, const unsigned char *ad,
                                             size_t ad_len, const unsigned char *nonce, const unsigned char *key)
{
    if (algorithm == kEncryptionAlgorithmChaCha20Poly1305)
