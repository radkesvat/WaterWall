 ...
 */
    ...
    defined(XZ_DEC_ARMTHUMB) || defined(XZ_DEC_SPARC) || defined(XZ_DEC_ARM64) || defined(XZ_DEC_RISCV)
#define XZ_DEC_BCJ
#endif
#endif
...
XZ_EXTERN void xz_sha256_update(const uint8_t *buf, size_t size, struct xz_sha256 *s);
