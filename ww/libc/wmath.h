...
#define WW_DEFINE_MINMAX_INTEGRAL(T, name, Name)                                                                       \
    static inline T wwMin##Name(T a, T b)                                                                              \
    {                                                                                                                  \
        return a < b ? a : b;                                                                                          \
    }                                                                                                                  \
    static inline T wwMax##Name(T a, T b)                                                                              \
    {                                                                                                                  \
        return a > b ? a : b;                                                                                          \
    }
...
static inline float wwMinFloat(float a, float b)
{
    return fminf(a, b);
}
static inline float wwMaxFloat(float a, float b)
{
    return fmaxf(a, b);
}
static inline double wwMinDouble(double a, double b)
{
    return fmin(a, b);
}
static inline double wwMaxDouble(double a, double b)
{
    return fmax(a, b);
}
static inline long double wwMinLDouble(long double a, long double b)
{
    return fminl(a, b);
}
static inline long double wwMaxLDouble(long double a, long double b)
{
    return fmaxl(a, b);
}
...
static inline uint32_t wwRotateLeft32(uint32_t value, unsigned int shift)
{
    unsigned int s = shift & 31U;
    if (s == 0U)
    {
        return value;
    }
