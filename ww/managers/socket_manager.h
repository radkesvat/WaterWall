...
/**
 * @brief Check a peer address against CIDR entries in an ACL.
 *
 * IPv4-mapped IPv6 peers and ranges contained within `::ffff:0:0/96` are normalized to IPv4 before matching.
 */
