                            ...
                            size_t adlen, const unsigned char *nonce, const unsigned char *key)
{
    ...
    // Perform encryption
    if (crypto_aead_chacha20poly1305_ietf_encrypt(dst, &ciphertext_len, src, srclen, ad, adlen, NULL, nonce, key) != 0)
    {
                            ...
                            size_t adlen, const unsigned char *nonce, const unsigned char *key)
{
    ...
    // Perform decryption
    if (crypto_aead_chacha20poly1305_ietf_decrypt(dst, &plaintext_len, NULL, src, srclen, ad, adlen, nonce, key) != 0)
    {
