 ...
 *
 * WARNING: this low-level function differs from RFC 7748 in another way:
 ...
 * const, and (depending on build flags) doesn't copy it.  WaterWall's
 * wCryptoSoftwareX25519 wrapper performs this normalization.
 *
 ...
 */
void x25519_sign_p2(unsigned char response[EC_PRIVATE_BYTES], const unsigned char challenge[EC_CHALLENGE_BYTES],
                    const unsigned char eph_secret[EC_UNIFORM_BYTES], const unsigned char secret[EC_PRIVATE_BYTES]);
 ...
 */
int x25519_verify_p2(const unsigned char response[X25519_BYTES], const unsigned char challenge[X25519_BYTES],
