...
MANIFEST = [
    ...
    ("tunnels/UdpConnector/upstream/fin.c", "udpconnectorTunnelUpStreamFinish", 2,
     ("UdpConnector: upstream Finish reached an unavailable UDP socket",
      "UdpConnector: failed to remove idle item for FD:%x"),
     "runtime flow-callback invariant: UdpConnector upstream fin socket liveness and idle-table removal"),
    ...
    ("tunnels/UdpConnector/upstream/payload.c", "udpconnectorTunnelUpStreamPayload", 1,
     ("UdpConnector: upstream payload reached an unavailable UDP socket",),
     "runtime flow-callback invariant: UdpConnector upstream payload socket liveness"),
    ...
    ("tunnels/MuxClient/common/helpers.c", "muxclientLeaveConnection", 1,
    ...
    ("tunnels/MuxServer/common/helpers.c", "muxserverLeaveConnection", 1,
    ...
    ("ww/net/line.h", "lineLock", 1,
     ("lineLock: attempted to lock dead line or reference count overflow",),
     "runtime line-lifetime invariant: lock after logical death or reference overflow"),
    ...
    ("ww/net/pipe_tunnel.c", "lineLockForce", 1,
     ("PipeTunnel: forced lock failed due to reference count overflow",),
     "runtime line-lifetime invariant: PipeTunnel forced lock reference overflow"),
