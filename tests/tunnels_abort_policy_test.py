...
MANIFEST = [
    ...
    ("ww/devices/device_frag_affinity.c", "deviceFragOfferLocked", 1,
     ("Device fragment assembly: best-fit allocation geometry changed",),
     "runtime allocator invariant: queried and acquired fragment storage geometry differ"),
...
EXCLUSIONS = [
    ...
    ("tunnels/MuxClient/upstream/payload.c", "muxclientTunnelUpStreamPayload",
     {"terminateProgram": 0, "abortProgramNow": 0, "requestProgramShutdown": 0},
     (),
     "Category-C: MuxClient payload entry delegates local child closure"),
    ("tunnels/MuxClient/upstream/payload.c", "muxclientSubmitChildPayload",
     {"terminateProgram": 0, "abortProgramNow": 0, "requestProgramShutdown": 0},
