...
CREATION_SITES = [
    ...
    ("tunnels/VlessClient/common/lifecycle.c", "createInternalLine", NORMAL_OWNER,
     "the internal UDP carrier line; the application line is borrowed"),
...
OWNER_CLOSE_SITES = [
    ("tunnels/HttpProxyServer/common/lifecycle.c", "hpsCloseChild",
    ...
    ("tunnels/HalfDuplexClient/common/helpers.c", "halfduplexclientClosePair",
...
OWNER_DESTROY_COUNTS = {
    ("tunnels/HalfDuplexClient/common/helpers.c", "halfduplexclientClosePair"): 4,
