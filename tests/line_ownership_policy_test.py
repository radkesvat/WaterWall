...
CREATION_SITES = [
    ...
    ("tunnels/UdpStatelessSocket/common/helpers.c", "udpstatelesssocketOnRecvFrom", NORMAL_OWNER,
...
OWNER_CLOSE_SITES = [
    ...
    ("tunnels/PacketsToConnection/common/helpers.c", "ptcCloseLineFromDownstream",
     "an lwIP-backed connection line finished by its neighbour"),
    ("tunnels/PacketsToStream/downstream/fin.c", "packetstostreamTunnelDownStreamFinish",
     "the recreated stream output line"),
    ("tunnels/MuxClient/downstream/fin.c", "muxclientTunnelDownStreamFinish",
     "the mux parent line; children are finished, never destroyed here"),
    ("tunnels/MuxServer/upstream/fin.c", "muxserverCloseOwnedChildLineFromUpstreamFinish",
     "a mux child line torn down with its parent"),
    ...
    ("tunnels/ReverseClient/downstream/fin.c", "reverseclientTunnelDownStreamFinish",
     "the paired upstream/downstream lines"),
...
OWNER_DESTROY_COUNTS = {
    ...
    ("tunnels/ReverseClient/downstream/fin.c", "reverseclientTunnelDownStreamFinish"): 4,
}
...
PACKET_LINE_FINISH = [
    ("tunnels/TunDevice/upstream/fin.c", "tundeviceTunnelUpStreamFinish",
     "unexpected upstream Finish on worker packet line", "TUN device, packet side only"),
    ("tunnels/TunDevice/downstream/fin.c", "tundeviceTunnelDownStreamFinish",
     "unexpected downstream Finish on worker packet line", "TUN device, packet side only"),
    ("tunnels/RawSocket/upstream/fin.c", "rawsocketUpStreamFinish",
     "unexpected upstream Finish on worker packet line", "raw socket, packet side only"),
    ("tunnels/RawSocket/downstream/fin.c", "rawsocketDownStreamFinish",
     "unexpected downstream Finish on worker packet line", "raw socket, packet side only"),
...
REQUIRED_CONTRACT_TESTS = [
    ...
    ("tests/unittests/packet_adapter_finish_test.c",
     ("tundeviceTunnelUpStreamFinish",
      "rawsocketUpStreamFinish"),
